...
export default function DossierView({ formData, onReset }) {
  ...
  return (
    ...
    >
      <div className="dossier-inner">
        ...
        >
          <div className="dossier-section-label">Phase 1 — {d.phase1Name || 'Reconnaissance'}</div>
          ...
          >
            ...
            <div className="dossier-crew-grid">
              {crewList.map((member, i) => (
                ...
                >
                  {member.threatLevel && (
                    <span className={`threat-badge ${threatBadgeClass[member.threatLevel] || ''}`}>
                      {member.threatLevel}
                    </span>
                  )}
